...
class FeedbackMails < ActionMailer::Base
  ...
  def send_order_now(order_info, order_items, total_formatted)
    ...
    mail :to => ["sysadmin@venki-spb.ru", "pavel.polushkin@gmail.com", "a_10@bk.ru"], :subject => 'Заказ на ритуальный-венок.рф'
